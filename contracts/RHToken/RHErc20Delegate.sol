...
/**
 * @title Compound's RHErc20Delegate Contract
 * @notice RHTokens which wrap an EIP-20 underlying and are delegated to
 * @author Compound
 */
contract RHErc20Delegate is RHErc20, CDelegateInterface {
    /**
